...
import org.ht.profileapi.facade.AccountManageLinkService;
...
public class AccountManageLinkController {
    ...
    private final AccountManageLinkService accMgmLinkService;

    public AccountManageLinkController(AccountManageLinkService accMgmLinkService) {
	...
	public ResponseEntity<ResponseData> getActLink(@RequestParam(name="htId",required=true) String htId,
		...
		ResponseData response = accMgmLinkService.getActLink(htId, prefixUrl);
	...
	public ResponseEntity<ResponseData> verifyActLink(@RequestParam(name="htId",required=true) String htId,
		...
		response = accMgmLinkService.verifyActLink(htId, url);
	...
	public ResponseEntity<ResponseData> getInvtLink(@RequestParam(name="htId", required=true) String htId
		...
		ResponseData response = accMgmLinkService.getInvtLink(htId, prefixUrl, contact);
		log.info(response.getMessage());
	...
	public ResponseEntity<ResponseData> verifyInvtLink(@RequestParam(name="htId", required=true) String htId
		...
		ResponseData p = accMgmLinkService.verifyInvtLink(htId, url, contact);
