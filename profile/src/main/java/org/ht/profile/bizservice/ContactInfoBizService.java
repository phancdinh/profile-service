...
public class ContactInfoBizService {
    ...
    public ContactInfoDto create(String htId, ContactInfoDto contactInfoDto) throws DataConflictingException, DataNotExistingException {
        ...
        return Optional.of(profileConverterHelper.convert(contactInfoDto, profileId))
                .map(contactInfoDataService::create)
                .map(contactInfo -> profileConverterHelper.convertToDto(contactInfo, htId, ContactInfoDto.class))
                .orElseThrow();
    }

    public ContactInfoDto findByHtId(String htId) throws DataNotExistingException {
